...
open(joinpath(@__DIR__, "..", "..", "results", "benchmarks", "julia_mp_benchmark.csv"), "w") do io
...
println("\n[OK] results/benchmarks/julia_mp_benchmark.csv  |  run python/benchmark_multiperiod.py for PyPSA")
